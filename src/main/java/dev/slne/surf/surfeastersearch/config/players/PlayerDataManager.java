...
public class PlayerDataManager {
    ...
    private static final NamespacedKey COLLECTED_PACKS_KEY = new NamespacedKey(SurfEasterSearch.getInstance(), "collected-packs");
    private static final NamespacedKey COLLECTED_EGGS_KEY = new NamespacedKey(SurfEasterSearch.getInstance(), "collected-eggs");
    private static final NamespacedKey TODAY_COLLECTED_EGGS = new NamespacedKey(SurfEasterSearch.getInstance(), "today-collected-eggs");
    static final NamespacedKey LAST_RESET_TIMESTAMP = new NamespacedKey(SurfEasterSearch.getInstance(), "limit-reset-timestamp");
    ...
    public static void addCollectedPackId(Player player, int packId) {
        ...
        int[] collectedPacks = container.getOrDefault(COLLECTED_PACKS_KEY, PersistentDataType.INTEGER_ARRAY, new int[0]);
    ...
    public static void addCollectedEggId(Player player, int eggId) {
        ...
        int[] collectedEggs = container.getOrDefault(COLLECTED_EGGS_KEY, PersistentDataType.INTEGER_ARRAY, new int[0]);
    ...
    public static int increaseTodayCollected(Player player) {
        ...
        int todayCollected = container.getOrDefault(TODAY_COLLECTED_EGGS, PersistentDataType.INTEGER, 0);
        todayCollected++;
